...
var style_Taux_20102015_12 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= -100.000000 && value <= -0.350000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.350000 && value <= 0.350000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.4 + size,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.350000 && value <= 46.240000) {
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.4 + size,
